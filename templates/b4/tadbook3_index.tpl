...
<{elseif $now_op=="list_docs"}>
    ...
    <div class="row">
        ...
        <div class="col-sm-9">
            ...
            <div style="font-size: 0.7em; margin: 10px 0px;"><{$smarty.const._MD_TADBOOK3_CREATE_DATE}> <{$create_date}></div>
        ...
        <form action="index.php" method="post">
            <table class="table table-hover">
                ...
                <tr>
                    ...
                    <td style="font-size: 0.7em; color: gray; text-align: right;white-space: nowrap;">
                        <{$doc.count}>
                    ...
                    <{if $my}>
                        <td style="white-space: nowrap;">
                            ...
                            <{if $doc.enable=='1'}>
                                <a href="<{$xoops_url}>/modules/tad_book3/index.php?op=change_enable&enable=0&tbdsn=<{$doc.tbdsn}>&tbsn=<{$tbsn}>" class="btn btn-xs btn-secondary"><{$smarty.const._TAD_UNABLE}></a>
                            <{else}>
