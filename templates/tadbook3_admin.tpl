            ...
            <{if $tbcsn!="" and $now_op!="tad_book3_cate_form"}>
                <div class="row">
                    ...
                    <div style="margin-top: 10px;">
                        ...
                        <a href="main.php?op=tad_book3_cate_form&tbcsn=<{$tbcsn|default:''}>" class="btn btn-sm btn-warning"><i class="fa fa-pencil" aria-hidden="true"></i>  <{$smarty.const._TAD_EDIT}></a>
                        <{/if}>
                    </div>
                    </div>
                </div>
                ...
                <form action="main.php" method="post" role="form">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <a href="<{$xoops_url}>/modules/tad_book3/index.php?op=tad_book3_form&tbsn=<{$book.tbsn}>" class="btn btn-sm btn-info" id="update<{$book.tbsn}>"><i class="fa fa-pencil" aria-hidden="true"></i>  <{$smarty.const._TAD_EDIT}></a>
                            </td>
                        </tr>
                        <{/foreach}>
                    </tbody>
